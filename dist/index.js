...
exports.buildQueryBean = buildQueryBean;
exports.tableSearchNode = tableSearchNode;
 ...
 */
function buildQueryBean(page, pageSize, searchNode, sortType, sortField) {
    var search = {
        'current': 1,
        'pageSize': 10,
        'search': false,
 ...
 * @param {isArray}: 是否为数组
 */
function tableSearchNode(prop, op, value, fieldType, isArray) {
    var node = {
        'prop': prop,
        'op': op,
        'value': value,
 ...
 */
function orFilters() {
    return [].concat(Array.prototype.slice.call(arguments)); // 将对象转为数组
};
...
function andFilters() {
    ...
    return arrType ? [].concat(Array.prototype.slice.call(arguments)) : console.error('参数中存在非法格式');
};